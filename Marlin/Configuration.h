...
#define STRING_CONFIG_H_AUTHOR "(VeDeVe, Ender-3 Pro)" // Who made the changes. // JV
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro 4.2.7 (JV 0.1)"
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN // JV
...
#define X_MIN_POS 3  // JV
#define Y_MIN_POS -3   // JV
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE + X_MIN_POS)  // JV
#define Y_MAX_POS (Y_BED_SIZE + Y_MIN_POS)  // JV
...
#define AUTO_BED_LEVELING_BILINEAR // JV
